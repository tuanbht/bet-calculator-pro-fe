...
import { calculateSurebet1Win2Refund, calculateSurebet2Win1Refund, calculateSurebet3Signals } from 'utils/calculator';
import { displayPercentage, displayPrice } from 'utils/number';

export default function Tempalate2() {
  const { type } = useParams();

  const mapping = {
    2: {
      title: 'Surebet',
      calculateFunc: calculateSurebet3Signals,
    },
    4: {
      title: 'Surebet : 2 Gagnants & 1 Remboursé',
      calculateFunc: calculateSurebet2Win1Refund,
    },
    5: {
      title: 'Surebet :  1 Gagnant & 2 Remboursés',
      calculateFunc: calculateSurebet1Win2Refund,
    },
  };
    ...
    <div>
      ...
      <Table responsive>
        ...
        <tbody>
          ...
          <tr>
            <td>Placez sur votre signe &quot;C&quot; (à Rembourser) :</td>
