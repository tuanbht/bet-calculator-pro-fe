...
import { calculateSurebet2Signals } from 'utils/calculator';
import { displayPercentage, displayPrice } from 'utils/number';

export default function Tempalate3() {
  ...
  const handleClickSubmit = (event) => {
    ...
    setCalculation(calculateSurebet2Signals(valueBet, valueRatingA, valueRatingB));
  };
